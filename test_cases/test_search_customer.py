...
class Test_04_Search_Customer:
    ...
    @pytest.mark.sanity #custom marker. Create pytest.ini folder
    ...
    def test_search_customer_by_companyname(self,setup):
        ...
        self.search_custmr = Search_Customer_Page(self.driver)
        self.search_custmr.enter_customer_companyname("Bookmundi Aps")
        self.search_custmr.click_search_button()
        time.sleep(3)
        is_cmpname_present = self.search_custmr.search_customer_by_company("Bookmundi Aps")
